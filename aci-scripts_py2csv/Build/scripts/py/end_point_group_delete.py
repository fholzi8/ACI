...
xmlfile = './../xml/end_point_group_delete.xml' # output
...
class cAEPg:
    ...
    """
        ...
        self.xml_epg_vmmdom  = """<fvRsDomAtt tDn="uni/vmmp-VMware/dom-{vmmdom_name}" instrImedcy="immediate" resImedcy="immediate" status="deleted"/>"""
